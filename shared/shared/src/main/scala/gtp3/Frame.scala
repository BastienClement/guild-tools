...
sealed trait Frame {
	...
	def ifChannelFrame(thunk: (ChannelFrame) => Unit) = {}
}
...
sealed trait ChannelFrame extends SequencedFrame {
	val channel: Int
	override def ifChannelFrame(thunk: (ChannelFrame) => Unit) = thunk(this)
}
...
case class HelloFrame(magic: Int, version: String)
		extends Frame
object HelloFrame {
...
case class HandshakeFrame(magic: Int, version: String, sockid: Long)
		extends Frame
...
case class ResumeFrame(sockid: Long, last_seq: Int)
		extends Frame
object ResumeFrame {
...
case class SyncFrame(last_seq: Int)
		extends Frame
object SyncFrame {
...
case class AckFrame(last_seq: Int)
		extends Frame
object AckFrame {
...
case class IgnoreFrame(padding: ByteVector)
		extends Frame
object IgnoreFrame {
...
case class OpenFrame(var seq: Int, sender_channel: Int,
                     channel_type: String, token: String, parent_channel: Int)
		extends Frame with SequencedFrame
object OpenFrame {
...
case class OpenSuccessFrame(var seq: Int, recipient_channel: Int, sender_channel: Int)
		extends Frame with SequencedFrame
...
case class OpenFailureFrame(var seq: Int, recipient_channel: Int, code: Int, message: String)
		extends Frame with SequencedFrame
...
case class ResetFrame(sender_channel: Int)
		extends Frame
object ResetFrame {
...
case class MessageFrame(var seq: Int, channel: Int,
                        message: String, flags: Int, payload: ByteVector)
		extends Frame with ChannelFrame with PayloadFrame
object MessageFrame {
...
case class RequestFrame(var seq: Int, channel: Int,
                        request: String, id: Int, flags: Int, payload: ByteVector)
		extends Frame with ChannelFrame with PayloadFrame
object RequestFrame {
...
case class SuccessFrame(var seq: Int, channel: Int,
                        request: Int, flags: Int, payload: ByteVector)
		extends Frame with ChannelFrame with PayloadFrame
object SuccessFrame {
...
case class FailureFrame(var seq: Int, channel: Int,
                        request: Int, code: Int, message: String, stack: String)
		extends Frame with ChannelFrame
object FailureFrame {
...
case class CloseFrame(var seq: Int, channel: Int, code: Int, message: String)
		extends Frame with ChannelFrame
object CloseFrame {
...
object Frame {
	...
	@inline def decode(buffer: Array[Byte]): Frame = decode(BitVector(buffer))
	def decode(buffer: BitVector): Frame = codec.decode(buffer).fold(_ => BadFrame(), res => res.value)
}
